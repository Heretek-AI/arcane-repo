...
[Znc](https://github.com/znc/znc) is a self-hosted deployment packaged as a Docker Compose template. This template provides everything needed to run Znc in a containerized environment with persistent storage, health checks, and environment-based configuration.
...
- **Project site:** [Znc](https://github.com/znc/znc)
